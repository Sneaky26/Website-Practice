...
public class aaa {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[4] Work with Shapes");
    ...
    static void demonstratePolymorphism() {
        ...
        // Create mix of Book and Ebook objects
        books[0] = new Book("Clean Code", "Robert Martin", 42.00f);
        books[1] = new Ebook("JavaScript Guide", "Sarah Wilson", 29.99f, 3.5f);
        books[2] = new Book("Design Patterns", "Gang of Four", 48.50f);
        books[3] = new Ebook("Web Development", "Mike Johnson", 35.00f, 5.2f);
        
        System.out.println("===== POLYMORPHISM DEMONSTRATION =====\n");
        System.out.println("Applying 20% discount to all books...\n");
        
        // Apply discount to all using polymorphism
        i = 0;
        while (i < books.length) {
            books[i].applyDiscount(20);
            i++;
        }
        
        // Display all books - polymorphism in action!
        System.out.println("Displaying all books (notice different formats):\n");
        i = 0;
        while (i < books.length) {
        ...
        System.out.println("👆 Notice how displayDetails() shows different info");
        System.out.println("for Book vs Ebook - that's polymorphism!");
    }
